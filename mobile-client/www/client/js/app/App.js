define(['jquery', 'backbone', '../thumbnailList/ThumbnailList', '../detailList/DetailList', '../songList/songList', '../modal/Modal', 'text!./app.html', 'bootstrap'], function ($, Backbone, ThumbnailList, DetailList, SongList, Modal, html) {
